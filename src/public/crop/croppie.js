...
(function (root, factory) {
    ...
    function _bindPoints(points) {
        if (points.length !== 4) {
            throw "crop - Invalid number of points supplied: " + points;
        }
        var self = this,
    ...
    function _rotate(deg) {
        if (!this.options.useCanvas || !this.options.enableOrientation) {
            throw 'crop: Cannot rotate without enableOrientation && EXIF.js included';
        }
            ...
            if (ot === 'string') {
                ...
                return this.each(function () {
                    ...
                    if ($.isFunction(method)) {
                        ...
                        throw 'crop ' + opts + ' method not found';
                    }
                });
            }
            else {
    ...
    function Croppie(element, opts) {
        if (element.className.indexOf('croppie-container') > -1) {
            throw new Error("crop: Can't initialize croppie more than once");
        }
